                ...
                <div class="container">
                    <div class="row justify-content-between">
                        <div class="col d-flex align-items-center">
                            <p class="mb-0 phone">
                                <span class="mailus">Phone no:</span> <a href="tel://+855 969 666 961">+855 969 666
                                    961</a> or
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a href="<?php echo APP_URL; ?>about.php" class="nav-link">About</a>
                            </li>
                            <li class="nav-item"><a href="<?php echo APP_URL; ?>services.php"
                                    class="nav-link">Services</a></li>
                            <li class="nav-item"><a href="<?php echo APP_URL; ?>rooms.php" class="nav-link">Apartment
                                    Room</a>
                            </li>
                            <li class="nav-item"><a href="<?php echo APP_URL; ?>contact.php"
                                    class="nav-link">Contact</a></li>
                            <?php if (!isset($_SESSION['username'])): ?>
                                <li class="nav-item"><a href="<?php echo APP_URL; ?>auth/login.php"
                                        class="nav-link">Login</a></li>
                                <li class="nav-item"><a href="<?php echo APP_URL; ?>auth/register.php"
                            ...
                            <?php else: ?>
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo APP_URL; ?>auth/logout.php">Logout</a>
                                        </li>
                                        <li><a class="dropdown-item" href="<?php echo APP_URL; ?>users/qr_login.php">Login
                                                via QR
                                                Code</a></li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo APP_URL; ?>auth/change_password.php"><i
