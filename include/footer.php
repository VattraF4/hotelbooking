...
<script src="<?php echo APP_URL; ?>js/popper.min.js"></script>
<script src="<?php echo APP_URL; ?>js/jquery-migrate-3.0.1.min.js"></script>
<script src="<?php echo APP_URL; ?>js/bootstrap.min.js"></script>
<script src="<?php echo APP_URL; ?>js/jquery.easing.1.3.js"></script>
<script src="<?php echo APP_URL; ?>js/jquery.waypoints.min.js"></script>
<script src="<?php echo APP_URL; ?>js/jquery.stellar.min.js"></script>
<script src="<?php echo APP_URL; ?>js/jquery.animateNumber.min.js"></script>
<script src="<?php echo APP_URL; ?>js/bootstrap-datepicker.js"></script>
<script src="<?php echo APP_URL; ?>js/jquery.timepicker.min.js"></script>
<script src="<?php echo APP_URL; ?>js/owl.carousel.min.js"></script>
