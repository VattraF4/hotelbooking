...
<section class="ftco-section bg-light">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
        <div class="d-block services-wrap text-center">
          <div class="img" style="background-image: url(![Image](https://github.com/user-attachments/assets/15a019e2-a989-4330-8954-960990702758));"></div>
          <div class="media-body py-4 px-3">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-8">
          ...
          <p class="copyright mb-0">
            <!-- Link back to ranavattra can't be removed. Template is licensed under ranavattra -->
            Copyright &copy;
